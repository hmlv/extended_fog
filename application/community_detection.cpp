...
/*
template <typename T>
bool community_detection_program<T>::set_forward_backward = false;

template <typename T>
u32_t community_detection_program<T>::num_tasks_to_sched = 0;

template <typename T>
u32_t community_detection_program<T>::iteration_times = 0;

template <typename T>
u32_t community_detection_program<T>::reduce_iters = 0;

template <typename T>
int community_detection_program<T>::forward_backward_phase = FORWARD_TRAVERSAL;

template <typename T>
int community_detection_program<T>::CONTEXT_PHASE = 0;

template <typename T>
int community_detection_program<T>::loop_counter = 0;

template <typename T>
bool community_detection_program<T>::init_sched = false;
